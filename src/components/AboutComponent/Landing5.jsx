...
const team = [
  { name: "Ronit", img: "./src/assets/ronit.png" },
  { name: "Arya", img: "./src/assets/arya.png" },
  { name: "Krish", img: "./src/assets/krish.png" },
  { name: "Rohan", img: "./src/assets/rohan.jpg" },
];
  ...
  <div className="bg-gradient-to-b from-black/90 to-[#18181b] text-gray-200 min-h-screen font-sans">
    ...
    <section className="max-w-4xl mx-auto px-6 py-16 text-center">
      ...
      <p className="mb-6 text-gray-400">
        A group of devs passionate about giving other devs a platform to shine.
      </p>
    ...
    <section className="text-center py-16 px-6">
      ...
      <button className="bg-gradient-to-r from-green-400 to-blue-500 hover:from-blue-500 hover:to-green-400 text-black font-semibold px-8 py-3 rounded-full transition text-lg shadow-xl">
        Create My Projects
      </button>
    </section>
    {/* Footer */}
